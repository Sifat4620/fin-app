...
@section('title', 'Monthly User Payments')
...
<div class="content-body">
    <div class="container">
        ...
        <div class="row page-titles mb-3">
            <div class="col">
                <h4 class="mb-0">📅 Monthly User Payments Report</h4>
                <small class="text-muted">Grouped by month and user</small>
            </div>
        </div>

        @forelse($monthlyData as $month => $users)
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-light">
                    <h5 class="mb-0">Month: {{ \Carbon\Carbon::parse($month . '-01')->format('F Y') }}</h5>
                </div>
                <div class="card-body">
        ...
        @empty
            <div class="alert alert-info">No monthly user payment data available.</div>
        @endforelse
